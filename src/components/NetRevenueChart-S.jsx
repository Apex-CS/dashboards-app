...
export default class S_PieChart extends Component {
  state = {
    inheritProps: {},
    netRevenue: {
      title: 'Net Revenue',
  ...
  render() { 
    ...
    return (
        <Row className="pieChartBox">
            ...
            <div className="legends legends_S">
                <DiscreteColorLegend startTitle="Values" width={140} items={[servers, storage, networking, services, finalConsumer, software]} />
            </div>
            <RadialChart
                className={'pieChart'}
                innerRadius={0}
