...
import '../../assets/css/dataNavigator.css';
...
const yearsInit= [2018, 2019, 2020];
const yearsEnd= [2018, 2019, 2020, 2021];
/*
...
export default class S_SideMenu extends Component {
            ...
            <Row className="sideMenu">
                <Col s={12} ><h1>Data Values</h1></Col>
                    ...
                    <Row className="buttonsRange">
                        ...
                        <Input s={12} className="selector" type='select' label="Month" value={this.props.rangeofValues.initMonth} onChange={ e => this.initMonth(e.target.value)}>{initialMonthList}</Input>
                        <Input s={12} type='select' label="Year" value={this.props.rangeofValues.initYear} onChange={ e => this.initYear(e.target.value)}>{initialYearList}</Input>

                        <Col s={12}>
                            <h6 s={12} className="rangeValues">Final</h6>
                        </Col>
                        <Input s={12} className="selector" type='select' label="Month" value={this.props.rangeofValues.endMonth}  onChange={ e => this.finalMonth(e.target.value)}>{endMonthList}</Input>
                        <Input s={12} type='select' label="Year" value={this.props.rangeofValues.endYear} onChange={ e => this.finalYear(e.target.value)}>{endYearList}</Input>
